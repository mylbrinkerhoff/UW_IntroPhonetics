...
\usepackage{parskip}    % better handling of spacing between paragraphs and paragraph indentation
...
%------------------------------------
\subsection*{Email communications} \label{sec:email}
%------------------------------------
All email correspondence should be conducted through UW email addresses or Canvas. I will do my best to respond to emails in a timely manner (within 24 hours of receiving them, excluding weekends and holidays). Remember that, due to UW’s interpretation of FERPA, grades cannot be discussed over email.

If you send me an email about the course from a personal account—such as Gmail, ProtonMail, or Apple email services—I will not respond.
